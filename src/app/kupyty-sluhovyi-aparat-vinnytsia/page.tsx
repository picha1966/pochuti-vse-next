...
export const metadata: Metadata = {
  ...
  description:
    'Купити слуховий апарат у Вінниці: підбір після скринінгу слуху, налаштування, гарантія 1 рік. 30+ років досвіду. Тел: +38 (067) 911-95-48. Вул. Театральна, 10.',
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'uk_UA',
    url: '/kupyty-sluhovyi-aparat-vinnytsia',
...
const faqs = [
  {
    ...
    answer:
      'Ціни на слухові апарати у Вінниці залежать від моделі та ступеня втрати слуху. Базові цифрові апарати — від 7 000 грн, середній клас — від 14 000 грн, преміальні моделі з Bluetooth — від 25 000 грн. Точну ціну визначаємо після скринінгу слуху.',
  },
  {
    question: 'Чи можна купити слуховий апарат без рецепта лікаря?',
    answer:
      'Так. Для придбання слухового апарату направлення від лікаря не потрібне. Ми самостійно проводимо скринінг слуху, визначаємо ступінь втрати слуху та підбираємо відповідну модель. Якщо у вас вже є результати обстеження — візьміть їх з собою.',
  },
  {
    question: 'Скільки часу займає підбір слухового апарату?',
    answer:
      'Перший візит зазвичай займає 60–90 хвилин. За цей час ми проводимо скринінг слуху, обговорюємо результати, підбираємо кілька варіантів апаратів та проводимо первинне налаштування обраної моделі.',
  },
  {
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <p className="text-lg text-slate-600 leading-relaxed mb-10">
          ...
          30-річним досвідом. Ми підбираємо слухові апарати після повноцінного скринінгу слуху,
        ...
        <div className="prose prose-slate max-w-none space-y-12">
            ...
            <ol className="space-y-4 text-slate-600 leading-relaxed list-none pl-0">
              {[
                ...
                },
                {
                  ...
                  d: 'Фахівець пояснює результати скринінгу слуху, визначає ступінь та характер втрати слуху, відповідає на запитання.',
                },
                {
                  n: '03',
                  t: 'Підбір моделей',
                  d: 'На основі результатів скринінгу слуху, способу життя та бюджету підбираємо 2–3 підходящі моделі для порівняння.',
                },
                {
                  n: '04',
                  t: 'Первинне налаштування',
                  d: 'Обрана модель програмується під ваш профіль слуху. Ви одразу оцінюєте різницю в якості звуку.',
                },
                {
                  n: '05',
          ...
          <section>
            ...
            <p className="text-slate-500 text-sm mt-4">
              ...
              Точну ціну визначаємо після скринінгу слуху.{' '}
          ...
          <section>
            ...
            <ul className="space-y-3 text-slate-600 leading-relaxed">
              {[
                ...
                'Скринінг слуху — без черги, без направлення від лікаря',

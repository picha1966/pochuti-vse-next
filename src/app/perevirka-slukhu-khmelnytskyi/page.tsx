...
export const metadata: Metadata = {
  title: { absolute: 'Перевірка слуху у Хмельницькому — аудіометрія | Почути Все' },
  description:
    'Перевірка слуху у Хмельницькому з цифровою аудіометрією. Безкоштовно лише при покупці слухового апарата у нашому центрі. Запис на консультацію.',
  alternates: { canonical: '/perevirka-slukhu-khmelnytskyi' },
  openGraph: {
    title: 'Перевірка слуху у Хмельницькому — аудіометрія | Почути Все',
    description:
      'Перевірка слуху у Хмельницькому з цифровою аудіометрією. Безкоштовно лише при покупці слухового апарата у нашому центрі. Запис на консультацію.',
    type: 'website',
    locale: 'uk_UA',
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Ні. Для проходження аудіометрії у нашому центрі у Хмельницькому направлення від ЛОРа або іншого лікаря не потрібне. Достатньо зателефонувати і записатися на зручний час.',
  },
  {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://sluh-apparat.vn.ua/perevirka-slukhu-khmelnytskyi',
            ...
            availableService: {
              ...
              description: 'Цифрова тональна аудіометрія у Хмельницькому. Визначення ступеня та характеру втрати слуху.',
            },
          }),
        }}
      />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Хмельницький', item: 'https://sluh-apparat.vn.ua/khmelnytskyi' },
              { '@type': 'ListItem', position: 3, name: 'Перевірка слуху у Хмельницькому', item: 'https://sluh-apparat.vn.ua/perevirka-slukhu-khmelnytskyi' },
            ],
          }),
        }}
      />
      ...
      <section className="relative overflow-hidden min-h-[440px] sm:min-h-[500px] flex items-center bg-transparent">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Перевірка слуху у Хмельницькому — аудіолог проводить аудіометрію у центрі «Почути Все»"
            fill
      ...
      <section className="py-14 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-500 mb-6 leading-relaxed">
            Не варто чекати, поки проблема стане очевидною. Запишіться на аудіометрію у Хмельницькому,

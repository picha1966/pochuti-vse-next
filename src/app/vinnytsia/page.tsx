...
export const metadata: Metadata = {
  ...
  description:
    'Купити слуховий апарат у Вінниці — підбір після аудіометрії, налаштування, ціни від 7 000 грн. 30+ років досвіду. Вул. Театральна, 10. +38 (067) 911-95-48.',
  alternates: { canonical: '/vinnytsia' },
  openGraph: {
    title: 'Купити слуховий апарат у Вінниці | Ціни та Підбір | Почути Все',
    description: 'Слухові апарати у Вінниці: ціни від 7 000 грн, безкоштовна аудіометрія, налаштування, гарантія 1 рік. 30+ років досвіду. +38 (067) 911-95-48.',
    type: 'website',
    locale: 'uk_UA',
  },
};
...
const services = [
  ...
  },
  {
    ...
    text: 'Підбираємо апарат з урахуванням аудіограми, способу життя, побажань та бюджету. Підходимо до кожного клієнта особисто.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    text: 'Програмуємо апарат під вашу аудіограму. Безкоштовні повторні налаштування протягом 30 днів після підбору.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const trustItems = [
  ...
  },
  {
    ...
    title: 'Безкоштовна діагностика', desc: 'Аудіометрія без направлення та без оплати',
  },
  {
          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Підбір слухового апарата починається з безкоштовної аудіометрії (перевірка слуху). За результатами аудіограми фахівець пропонує оптимальні моделі. Після вибору апарат налаштовується під вашу аудіограму. Весь процес займає 1–2 години.',
                },
              },
              {
                '@type': 'Question',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://sluh-apparat.vn.ua/vinnytsia',
      ...
      <section className="py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg prose-slate max-w-none text-slate-600 space-y-4">
            ...
            <p>
              Центр слуху <strong className="text-slate-800">«Почути Все»</strong> у Вінниці — це не магазин і не звичайна аптека. Це спеціалізований центр, де ви отримаєте повний цикл допомоги: від безкоштовної аудіометрії до довгострокового супроводу після підбору апарату.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-slate max-w-none text-slate-600 space-y-4">
            ...
            <p>
              ...
              з аудіометрії: ми визначаємо точний профіль слуху та підбираємо оптимальну
          ...
          <div className="prose prose-slate max-w-none text-slate-600">
            <p>
              Ми проводимо <strong>безкоштовну аудіометрію</strong> у Вінниці (вул. Театральна, 10) —
              без черги та без направлення лікаря. Комп&apos;ютерна перевірка слуху займає близько
              30 хвилин. За результатами ви отримаєте детальну аудіограму та рекомендацію фахівця.
              Зателефонуйте{' '}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              {
                name: 'Петро, 66 років',
                text: 'Прийшов після того, як ЛОР порадив звернутися. Зробили аудіометрію, підібрали апарат за 1 візит. Налаштування зайняло менше години. Дуже задоволений сервісом.',
              },
              {
                name: 'Олена, 58 років',
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'Ціни залежать від класу апарату: базові — від 7 000 грн, середній клас — від 14 000 грн, преміум — від 25 000 грн. Підбір проводиться після аудіометрії — ми рекомендуємо тільки те, що реально потрібно.',
              },
              {
                q: 'Чи потрібне направлення лікаря для перевірки слуху?',
                a: 'Ні. Аудіометрія у нашому центрі проводиться без направлення та безкоштовно. Достатньо зателефонувати та записатися на зручний час.',
              },
              {
      ...
      <section className="py-14 bg-slate-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-slate-300 mb-8 text-base leading-relaxed">
            ...
            Підберемо ідеальний апарат після аудіограми — без тиску та нав&apos;язування.
          </p>
          <a
            href="tel:+380679119548"

...
export const metadata: Metadata = {
  ...
  description:
    'Налаштування слухового апарата у Вінниці та Хмельницькому. Програмування під аудіограму, повторні коригування, довгострокова підтримка. Тел: +38 (067) 911-95-48.',
  alternates: { canonical: '/nalashtuvannya-sluhovoho-aparata' },
  openGraph: {
    title: 'Налаштування слухового апарата | Центр слуху «Почути Все»',
    description: 'Як проходить налаштування слухового апарата. Програмування під аудіограму у Вінниці та Хмельницькому. Тел: +38 (067) 911-95-48.',
    type: 'website',
    locale: 'uk_UA',
  },
};
...
const faqs = [
  {
    ...
    answer:
      'Налаштування здійснюється за допомогою спеціального програмного забезпечення виробника. Фахівець підключає апарат до комп\'ютера, завантажує аудіограму та налаштовує параметри підсилення на кожній частоті. Процедура займає 30–45 хвилин.',
  },
  {
...
const steps = [
  {
    n: '01',
    t: 'Аудіометрія або аналіз наявної аудіограми',
    d: 'Якщо аудіограми ще немає — проводимо комп\'ютерну аудіометрію. Це займає 20–30 хвилин і дає точну картину стану слуху на кожній частоті.',
  },
  {
    n: '02',
    t: 'Підключення апарату до програмного забезпечення',
    d: 'Апарат підключається до спеціалізованого ПЗ виробника. Фахівець бачить поточні параметри налаштування та аудіограму.',
  },
  {
    n: '03',
    t: 'Програмування під аудіограму',
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 text-slate-600 leading-relaxed text-base mb-8">
            <p>
              Налаштування — це програмування апарату під індивідуальну аудіограму користувача.
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              ...
              },
              {
                ...
                alt: 'Сучасне обладнання для аудіометрії та налаштування апаратів',
                caption: 'Сучасне діагностичне обладнання',
              },
              {
                src: '/images/clinic/clinic-fitting.png',
                alt: 'Процес налаштування слухового апарата під аудіограму клієнта',
                caption: 'Налаштування під аудіограму',
              },
            ].map((img) => (
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 mt-2">Прозора процедура — від аудіометрії до виходу з офісу</p>
          </div>

...
export const metadata: Metadata = {
  title: { absolute: 'Перевірка слуху у Вінниці — скринінг слуху | Почути Все' },
  description:
    'Перевірка слуху у Вінниці — цифровий скринінг слуху. Безкоштовно при купівлі апарата. Без направлення. Центр слуху «Почути Все».',
  alternates: { canonical: '/perevirka-slukhu-vinnytsia' },
  openGraph: {
    title: 'Перевірка слуху у Вінниці — скринінг слуху | Почути Все',
    description:
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Ні. Для проходження скринінгу слуху у нашому центрі у Вінниці направлення від ЛОРа або іншого лікаря не потрібне. Достатньо зателефонувати і записатися на зручний час.',
  },
  {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://pochutyvse.com.ua/perevirka-slukhu-vinnytsia',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Вінниця', item: 'https://pochutyvse.com.ua/vinnytsia' },
              { '@type': 'ListItem', position: 3, name: 'Перевірка слуху у Вінниці', item: 'https://pochutyvse.com.ua/perevirka-slukhu-vinnytsia' },
            ],
          }),
        }}
      />
      ...
      <section className="relative overflow-hidden min-h-[440px] sm:min-h-[500px] flex items-center bg-transparent">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Перевірка слуху у Вінниці — фахівець проводить комп'ютерний скринінг слуху у центрі «Почути Все»"
            fill
      ...
      <section className="py-14 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-500 mb-6 leading-relaxed">
            Не варто чекати, поки проблема стане очевидною. Запишіться на скринінг слуху у Вінниці,

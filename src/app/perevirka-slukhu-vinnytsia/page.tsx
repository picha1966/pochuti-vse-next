...
export const metadata: Metadata = {
  title: { absolute: 'Перевірка слуху у Вінниці — аудіометрія | Почути Все' },
  description:
    'Перевірка слуху у Вінниці з цифровою аудіометрією. Безкоштовно лише при покупці слухового апарата у нашому центрі. Тел: +38 (067) 911-95-48. Вул. Театральна, 10.',
  alternates: { canonical: '/perevirka-slukhu-vinnytsia' },
  openGraph: {
    title: 'Перевірка слуху у Вінниці — аудіометрія | Почути Все',
    description:
      'Перевірка слуху у Вінниці з цифровою аудіометрією. Безкоштовно лише при покупці слухового апарата у нашому центрі. Запис на прийом.',
    type: 'website',
    locale: 'uk_UA',
...
const faqs = [
  {
    ...
    a: 'Ні. Аудіометрія — повністю безболісна процедура. Пацієнт надягає навушники і реагує на звукові сигнали різної частоти та гучності. Жодних ін\'єкцій чи інструментів.',
  },
  {
    q: 'Скільки триває перевірка слуху?',
    a: 'Стандартна тональна аудіометрія займає 20–30 хвилин. Разом з консультацією фахівця і поясненням результатів — близько 45–60 хвилин.',
  },
  {
    q: 'Чи потрібне направлення лікаря для перевірки слуху у Вінниці?',
    a: 'Ні. Для проходження аудіометрії у нашому центрі у Вінниці направлення від ЛОРа або іншого лікаря не потрібне. Достатньо зателефонувати і записатися на зручний час.',
  },
  {
    q: 'Чи можна пройти перевірку слуху без купівлі апарата?',
    a: 'Так. Аудіометрія проводиться незалежно від того, чи плануєте ви купувати апарат. Ми надамо результати та рекомендації. Зауважте: перевірка слуху безкоштовна лише при підборі слухового апарата в нашому центрі.',
  },
];

const steps = [
  { n: '01', t: 'Запис на прийом', d: 'Зателефонуйте або залиште заявку. Оберемо зручний час у нашому центрі у Вінниці.' },
  { n: '02', t: 'Діагностика (20–30 хв)', d: 'Цифрова аудіометрія: тональний тест через навушники, оцінка розбірливості мови на різних частотах.' },
  { n: '03', t: 'Аналіз результатів', d: 'Фахівець пояснює аудіограму зрозумілою мовою: яка частота знижена, наскільки серйозна втрата.' },
  { n: '04', t: 'Рекомендації', d: 'На основі аудіограми надаємо рекомендації: спостереження, підбір апарату або консультація ЛОРа.' },
];

export default function HearingTestVinnytsia() {
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://sluh-apparat.vn.ua/perevirka-slukhu-vinnytsia',
            ...
            availableService: {
              ...
              name: 'Перевірка слуху (аудіометрія)',
              procedureType: 'DiagnosticProcedure',
              description: 'Цифрова тональна аудіометрія у Вінниці. Визначення ступеня та характеру втрати слуху.',
            },
          }),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'BreadcrumbList',
            itemListElement: [
              { '@type': 'ListItem', position: 1, name: 'Головна', item: 'https://sluh-apparat.vn.ua' },
              { '@type': 'ListItem', position: 2, name: 'Вінниця', item: 'https://sluh-apparat.vn.ua/vinnytsia' },
              { '@type': 'ListItem', position: 3, name: 'Перевірка слуху у Вінниці', item: 'https://sluh-apparat.vn.ua/perevirka-slukhu-vinnytsia' },
            ],
          }),
        }}
      />
      ...
      <section className="relative overflow-hidden min-h-[440px] sm:min-h-[500px] flex items-center bg-transparent">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/hero-vinnytsia-hearing.jpg"
            alt="Перевірка слуху у Вінниці — аудіолог проводить аудіометрію у центрі «Почути Все»"
            fill
        ...
        <div className="relative z-20 w-full py-16 lg:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-lg sm:text-xl text-white/85 leading-relaxed mb-8">
              Професійна цифрова аудіометрія.<br />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">
              Що входить у перевірку слуху у Вінниці
            </h2>
            <p className="text-slate-500 mt-2 max-w-xl mx-auto">
              Повний діагностичний цикл — від аудіометрії до рекомендацій фахівця
            </p>
          </div>
            ...
            {[
              {
                ...
                title: 'Тональна аудіометрія',
                text: 'Визначення порогів слуху на частотах 250–8000 Гц. Результат — детальна аудіограма.',
              },
              {
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              },
              {
                ...
                text: 'Пояснення результатів аудіограми зрозумілою мовою без медичного жаргону.',
              },
              {
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                text: 'За результатами аудіограми підбираємо оптимальну модель апарату.',
              },
            ].map((item) => (
      ...
      <section className="py-14 bg-slate-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-5">
            Скільки коштує перевірка слуху у Вінниці?
          </h2>
            ...
            <div className="flex items-start gap-4 mb-5">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  Перевірка слуху у Вінниці проводиться безкоштовно для клієнтів, які купують слуховий
                  апарат у нашому центрі. В інших випадках умови консультації уточнюються під час запису.
                </p>
              </div>
            </div>
            <a
      ...
      <section className="py-14 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-6">
            Перевірка слуху у Вінниці: кому рекомендована?
          </h2>
          <p className="text-slate-500 mb-6 leading-relaxed">
            Не варто чекати, поки проблема стане очевидною. Запишіться на аудіометрію у Вінниці,
          ...
          <ul className="space-y-3">
            {[
              ...
              { icon: '🩺', text: 'ЛОР-лікар або сімейний лікар направив вас на аудіометрію' },
            ].map((item) => (
      ...
      <section className="py-14 bg-[#1F3D2B]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-white mb-8 text-center">
            Де пройти перевірку слуху у Вінниці
          </h2>
          <div className="bg-white/10 rounded-3xl p-8 grid grid-cols-1 sm:grid-cols-3 gap-6 text-white">
            <div className="flex flex-col gap-1">
              ...
              <span className="font-semibold">м. Вінниця</span>
              <span className="text-white/80 text-sm">вул. Театральна, 10, офіс 207</span>
            </div>
            <div className="flex flex-col gap-1">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 text-center mb-10">
            Часті питання про перевірку слуху у Вінниці
          </h2>

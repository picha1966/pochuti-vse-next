...
export const metadata: Metadata = {
  ...
  description:
    'Купити слуховий апарат у Хмельницькому — підбір після аудіометрії, налаштування, ціни від 7 000 грн. 30+ років досвіду. Вул. Кам\'янецька, 19/А. +38 (067) 911-95-48.',
  alternates: { canonical: '/khmelnytskyi' },
  openGraph: {
    title: 'Купити слуховий апарат у Хмельницькому | Ціни та Підбір | Почути Все',
    description: 'Слухові апарати у Хмельницькому: ціни від 7 000 грн, безкоштовна аудіометрія, налаштування, гарантія 1 рік. 30+ років досвіду. +38 (067) 911-95-48.',
    type: 'website',
    locale: 'uk_UA',
  },
};
...
const services = [
  {
    ...
    title: 'Аудіометрія безкоштовно',
    text: 'Сучасна комп\'ютерна перевірка слуху без направлення. Складаємо детальну аудіограму та пояснюємо результати зрозумілою мовою.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    text: 'Налаштовуємо апарат за аудіограмою на комп\'ютерній станції. Безкоштовні повторні корекції протягом 30 днів.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const trustItems = [
  ...
  },
  {
    ...
    title: 'Сучасне обладнання', desc: "Комп'ютерна аудіометрія та програмування апаратів",
  },
  {
          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Спочатку проводиться безкоштовна аудіометрія, за результатами якої фахівець підбирає апарат. Потім апарат програмується під вашу аудіограму. Весь процес — 1–2 години. Безкоштовні повторні налаштування — 30 днів.',
                },
              },
              {
                '@type': 'Question',
                name: 'Чи проводите ви аудіометрію у Хмельницькому безкоштовно?',
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Так, перевірка слуху (аудіометрія) у нашому центрі у Хмельницькому безкоштовна. Направлення лікаря не потрібне. Зателефонуйте +38 (067) 911-95-48 для запису.',
                },
              },
              {
                '@type': 'Question',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://sluh-apparat.vn.ua/khmelnytskyi',
      ...
      <section className="py-12 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-slate max-w-none text-slate-600 space-y-4">
            ...
            <p>
              Якщо ви шукаєте <strong>слуховий апарат у Хмельницькому</strong> — починайте з безкоштовної аудіометрії. Без точної аудіограми неможливо правильно підібрати апарат. Ми визначимо профіль втрати слуху та запропонуємо оптимальні моделі у вашому бюджеті. <strong>Ціни — від 7 000 грн.</strong>
            </p>
            <p>
              <strong>Підбір слухового апарату</strong> у нашому центрі — це не продаж. Це консультація, аудіометрія, порівняння моделей та налаштування. Ви йдете додому з апаратом, який реально покращує ваш слух, а не просто лежить у ящику.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'Ні. Аудіометрія у нашому центрі у Хмельницькому безкоштовна та без направлення. Просто зателефонуйте та запишіться на зручний час.',
              },
              {
                q: 'Які слухові апарати підходять для людей похилого віку?',
                a: 'Для людей похилого віку найчастіше рекомендуємо завушні апарати середнього класу — вони прості в управлінні та надійні. Конкретну модель підбираємо після аудіограми.',
              },
              {
      ...
      <section className="py-14 bg-slate-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-slate-300 mb-8 text-base leading-relaxed">
            ...
            проведемо аудіометрію та підберемо апарат, який реально вам підходить.
          </p>
          <a
            href="tel:+380679119548"

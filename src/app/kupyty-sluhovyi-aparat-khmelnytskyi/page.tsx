...
export const metadata: Metadata = {
  ...
  description:
    'Купити слуховий апарат у Хмельницькому: підбір після скринінгу слуху, налаштування, гарантія 1 рік. 30+ років досвіду. Тел: +38 (067) 911-95-48. Вул. Кам\'янецька, 19/А.',
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'uk_UA',
    url: '/kupyty-sluhovyi-aparat-khmelnytskyi',
...
const faqs = [
  {
    ...
    answer:
      'Ціни на слухові апарати у Хмельницькому: базові цифрові — від 7 000 грн, середній клас — від 14 000 грн, преміальні моделі з Bluetooth — від 25 000 грн. Точну ціну визначаємо після скринінгу слуху індивідуально.',
  },
  {
    question: 'Як проходить перший візит до центру слуху у Хмельницькому?',
    answer:
      'Перший візит займає близько 60–90 хвилин. Ми проводимо скринінг слуху, пояснюємо результати, підбираємо 2–3 варіанти апаратів та виконуємо первинне налаштування обраної моделі. Ніякого тиску — рішення завжди за вами.',
  },
  {
    question: 'Чи потрібне направлення від лікаря для підбору апарату?',
    answer:
      'Ні. Для відвідування нашого центру направлення від лікаря не потрібне. Ми самостійно проводимо комп\'ютерний скринінг слуху та визначаємо ступінь втрати слуху. Якщо у вас вже є результати обстеження — візьміть їх з собою.',
  },
  {
    question: 'Як налаштовується слуховий апарат після покупки?',
    answer:
      'Після купівлі апарат програмується під ваш індивідуальний профіль слуху. Протягом перших 30 днів ви можете повернутися на безкоштовне коригування налаштувань — щоб апарат повністю відповідав вашим очікуванням.',
  },
  {
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <p className="text-lg text-slate-600 leading-relaxed mb-10">
          ...
          зі слухопротезування: від скринінгу слуху та підбору апарату до налаштування,
        ...
        <div className="prose prose-slate max-w-none space-y-12">
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed mt-3">
              ...
              Для кожного ми підбираємо апарат з урахуванням профілю слуху, способу життя,
          ...
          <section>
            ...
            <ol className="space-y-4 text-slate-600 leading-relaxed list-none pl-0">
              {[
                ...
                {
                  n: '02',
                  t: 'Комп\'ютерний скринінг слуху',
                  d: 'Точна перевірка слуху на сучасному обладнанні. Визначаємо ступінь та характер втрати. 20–30 хвилин.',
                },
                {
                  n: '03',
                  t: 'Вибір моделі',
                  d: 'Підбираємо варіанти з урахуванням профілю слуху, зручності управління та бюджету. Ніякого нав\'язування.',
                },
                {
                  n: '04',
                  t: 'Налаштування та примірка',
                  d: 'Програмуємо апарат під ваш профіль слуху. Ви чуєте різницю одразу — ще в офісі.',
                },
                {
                  n: '05',
          ...
          <section>
            ...
            <ul className="space-y-3 text-slate-600 leading-relaxed">
              {[
                ...
                'Скринінг слуху без черги та без направлення від лікаря',

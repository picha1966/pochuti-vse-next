...
const faqs = [
  {
    ...
    answer:
      'Ціни на слухові апарати: базові цифрові — від 7 000 грн, середній клас з шумозаглушенням — від 14 000 грн, преміум з Bluetooth та зарядкою — від 25 000 грн. Конкретну модель визначаємо після безкоштовного скринінгу слуху. Можлива розстрочка та державна компенсація.',
  },
  {
    question: 'Чи потрібне направлення лікаря для перевірки слуху?',
    answer:
      'Ні. Ми проводимо безкоштовний скринінг слуху без направлення та без попереднього запису до ЛОРа. Достатньо зателефонувати та обрати зручний час. Перевірка займає близько 30 хвилин.',
  },
  {
    question: 'Чи підійде слуховий апарат для літньої людини?',
    answer:
      'Так, ми спеціалізуємося на підборі апаратів для людей різного віку. Для старшого покоління рекомендуємо завушні моделі з простим керуванням та тривалим ресурсом батарейок. Апарат підбирається індивідуально після скринінгу слуху.',
  },
  {

...
const testimonials = [
  ...
  },
  {
    ...
    city: 'Хмельницький',
    quote:
      'Звернувся вперше — не знав, чого очікувати. Провели скринінг слуху, запропонували кілька варіантів. Зупинився на середньому класі. Ношу вже рік — жодних нарікань.',
  },
  {
    name: 'Ніна',
    age: 61,
  ...
  },
  {
    ...
    city: 'Вінниця',
    quote:
      'Прийшов разом із дружиною — вона наполягла. Після скринінгу слуху виявилося, що втрата слуху серйозна. Зараз розумію, що зволікав даремно.',
  },
  {
    name: 'Людмила',
    age: 67,
